...
# Exercise 3: New column Total
df1["Total"] = df1[["Math", "English", "Science"]].sum(axis=1)

# Exercise 4: Bar chart average per subject
df1_subject_avg = df1[["Math", "English", "Science"]].mean()
df1_subject_avg.plot(kind="bar", title="Average Grade per Subject")
plt.show()
...
# Exercise 4: Line chart sales trend
...
# Exercise 3: New column Salary Increase
min_salary = df3["Salary"].min()
df3["Salary Increase %"] = ((df3["Salary"] - min_salary) / min_salary) * 100

# Exercise 4: Bar chart employee distribution
